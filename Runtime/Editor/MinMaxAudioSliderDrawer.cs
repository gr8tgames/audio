...
{
  [CustomPropertyDrawer(typeof(MinMaxAudioSettingAttribute))]
  public class MinMaxAudioSliderDrawer : PropertyDrawer
  {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {

      var minMaxAttribute = (MinMaxAudioSettingAttribute)attribute;
